...
private fun sampleList(): List<StoriesModel.Slide> {
    return listOf(
        ...
        StoriesModel.Slide(drawableBackground(R.drawable.sample_slide_2), { SlideOverlay() })
    )
}
